        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
             ...
             //   mMap.setInfoWindowAdapter(new InfoWindow(getLayoutInflater()));
                Toast.makeText(LocalizacionActivity.this,"Latitud: "+latitud+ " Longitud: "+longitud, Toast.LENGTH_LONG);
                ...
                /*mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
                    ...
                    public void onMapClick(LatLng latLng) {
                       ...
                       // mMap.setInfoWindowAdapter(new InfoWindow(getLayoutInflater()));
                        ...
                        LocalizacionActivity.this.latitudM2 = latLng.latitude;
                        LocalizacionActivity.this.longitudM2 = latLng.longitude;
                        ...
                        LocalizacionActivity.this.distancia = locActual.distanceTo(locMaarca2);
