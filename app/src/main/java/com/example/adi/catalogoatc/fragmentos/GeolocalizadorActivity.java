...
public class GeolocalizadorActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geolocalizador2);
               ...
               // mMap.setInfoWindowAdapter(new InfoWindow(getLayoutInflater()));
                ...
                mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
                    ...
                    public void onMapClick(LatLng latLng) {
                        ...
                        GeolocalizadorActivity.this.latitudM2=latLng.latitude;
                        GeolocalizadorActivity.this.longitudM2=latLng.longitude;
                        ...
                        GeolocalizadorActivity.this.distancia= locActual.distanceTo(locMaarca2);
